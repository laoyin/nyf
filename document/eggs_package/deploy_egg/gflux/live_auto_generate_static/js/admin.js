...
function saveUserType(){
    ...
    var checked=document.getElementById('custom_report').checked
    if(checked){
    ...
    $.post(url_prefix+'ajax/update_user_type/',{user_name:user_name,user_type:user_type,enable_advanced_features:enable_advanced_features},
    function(data){
        if(data['ret']=='ok'){
