...
from gflux.apps.station.sql_utils import import_shell_history_data
...
class Command(django_gearman_commands.GearmanWorkerBaseCommand):
    @property
    def task_name(self):
        return 'import_shell_history_data'
    ...
    def do_job(self, job_data):
        try:
            ...
            #import
            start_date,end_date=import_shell_history_data(args['site'],
                                args['file'],
                                args['location'],
                                args['location_desc'],
                                args['userid'],
