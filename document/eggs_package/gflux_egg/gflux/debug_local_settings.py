...
DATABASES = {
    'default': {
        ...
        #'PASSWORD': 'wangdong',
        'PASSWORD': 'pku123wd',
        'HOST': 'gflux1.tmlsystem.com',             # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SQL_BACKENDS = [
    {
        ...
        'db_url': 'postgresql://wangdong:pku123wd@gflux1.tmlsystem.com/new_gflux',
        'db_pool_size': 15,
        'db_charset': 'utf-8',
    ...
    },
    {
        'db_name': 'db3',
        #'db_url': 'postgresql://wangdong:wangdong@127.0.0.1/gflux',
        'db_url': 'postgresql://tao:pku123@gflux3.tmlsystem.com/gflux',
        'db_pool_size': 15,
        'db_charset': 'utf-8',
        'db_pool_recycle': 20000
    },
